...
{
    public class ProgramDay01
    {
        public static void Run()
        {
            Console.WriteLine("ProgramDay01");
        ...
        static string[] partOneInputValuesTest1 = new string[]
        {
            "+1",
            "+1",
            "+1"
        ...
        static string[] partOneInputValuesTest2 = new string[]
        {
            "+1",
            "+1",
            "-2"
        ...
        static string[] partOneInputValuesTest3 = new string[]
        {
            "-1",
            "-2",
            "-3"
        ...
        static string[] partTwoInputValuesTest1 = new string[]
        {
            "+1", "-1"
        };

        static string[] partTwoInputValuesTest2 = new string[]
        {
            "+3", "+3", "+4", "-2", "-4"
        };

        static string[] partTwoInputValuesTest3 = new string[]
        {
            "-6", "+3", "+8", "+5", "-6"
        };


        static string[] partTwoInputValuesTest4 = new string[]
        {
            "+7", "+7", "-2", "-7", "-4"
        };
